package com.vnd.rtr5.x14_tesselation.x2_triangle;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, GestureDetector.OnDoubleTapListener, GestureDetector.OnGestureListener {
    ...
    public boolean onSingleTapConfirmed(@NonNull MotionEvent event) {
        triangleSubdivisions = (triangleSubdivisions + 1) % maxTesselationLevel[0];
        return true;
    }
...
// tesselation control shader
        final String tcsShaderSourceCode =
                "#version 320 es" +
                        ...
                        "uniform int uTriangleSubdivision;" +
                        ...
                        "gl_TessLevelInner[0] = float(uTriangleSubdivision);" +
                        "gl_TessLevelInner[1] = 0.0f;" + // doesnt do anything
        ...
        final String tesShaderSourceCode =
                "#version 320 es" +
                        ...
                        "{" +
                        "gl_PointSize = 10.0;" +
                        "gl_Position = uMVPMatrix * ((gl_TessCoord.x * gl_in[0].gl_Position) + (gl_TessCoord.y * gl_in[1].gl_Position) +(gl_TessCoord.z * gl_in[2].gl_Position));" +
                        "}";
        ...
        triangleSubdivisionUniform = GLES32.glGetUniformLocation(shaderProgramObject, "uTriangleSubdivision");
    ...
    private void display() {
        ...
        final float[] color = {1.0f, 1.0f, 0.0f, 1.0f};
        GLES32.glUniform4fv(colorUniform, 1, color, 0);
        GLES32.glUniform1i(triangleSubdivisionUniform, triangleSubdivisions);
