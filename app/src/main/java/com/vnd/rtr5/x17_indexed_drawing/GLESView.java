package com.vnd.rtr5.x17_indexed_drawing;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, GestureDetector.OnDoubleTapListener, GestureDetector.OnGestureListener {
    private final int[] vbo_index_rectangle = new int[1];
    ...
    private void initialize(GL10 gl) {
        ...
        GLES32.glGenBuffers(1, vbo_index_rectangle, 0);
        GLES32.glBindBuffer(GLES32.GL_ELEMENT_ARRAY_BUFFER, vbo_index_rectangle[0]);
        // prepare rectangle vertices array for glBufferData
        // step1 enough bytebuffer allocate
        // step2 set byteorder
        // step3 treat as float buffer
        ...
        GLES32.glBufferData(GLES32.GL_ELEMENT_ARRAY_BUFFER, indices.length * 2, shortBufferIndices, GLES32.GL_STATIC_DRAW);
    ...
    private void display() {
        ...
        GLES32.glBindVertexArray(vao_rectangle[0]);
        GLES32.glBindBuffer(GLES32.GL_ELEMENT_ARRAY_BUFFER, vbo_index_rectangle[0]);
        GLES32.glDrawElements(GLES32.GL_TRIANGLES, 6, GLES32.GL_UNSIGNED_SHORT, 0); // indices.size(), indices[0] type, indices start from
        GLES32.glBindVertexArray(0);
    ...
    public void uninitialize() {
        ...
        // rectangle
        if (vbo_index_rectangle[0] > 0) {
            GLES32.glDeleteBuffers(1, vbo_index_rectangle, 0);
            vbo_index_rectangle[0] = 0;
        }
