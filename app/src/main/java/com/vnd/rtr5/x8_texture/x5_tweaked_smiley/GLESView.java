package com.vnd.rtr5.x8_texture.x5_tweaked_smiley;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, GestureDetector.OnDoubleTapListener, GestureDetector.OnGestureListener {
    ...
    private void display() {
        ...
        float[] square_texture_coordinates = new float[4 * 2];
        if (singleTap == 1) {
            // smiley
            square_texture_coordinates[0] = 1.0f;
            square_texture_coordinates[1] = 1.0f;
            square_texture_coordinates[2] = 0.0f;
            square_texture_coordinates[3] = 1.0f;
            square_texture_coordinates[4] = 0.0f;
            square_texture_coordinates[5] = 0.0f;
            square_texture_coordinates[6] = 1.0f;
            square_texture_coordinates[7] = 0.0f;

            GLES32.glUniform1i(singleTapUniform, 1);
        } else if (singleTap == 2) {
            // tweaked smiley
            square_texture_coordinates[0] = 0.5f;
            square_texture_coordinates[1] = 0.5f;
            square_texture_coordinates[2] = 0.0f;
            square_texture_coordinates[3] = 0.5f;
            square_texture_coordinates[4] = 0.0f;
            square_texture_coordinates[5] = 0.0f;
            square_texture_coordinates[6] = 0.5f;
            square_texture_coordinates[7] = 0.0f;

            GLES32.glUniform1i(singleTapUniform, 1);
        } else if (singleTap == 3) {
            // 4 smileys
            square_texture_coordinates[0] = 2.0f;
            square_texture_coordinates[1] = 2.0f;
            square_texture_coordinates[2] = 0.0f;
            square_texture_coordinates[3] = 2.0f;
            square_texture_coordinates[4] = 0.0f;
            square_texture_coordinates[5] = 0.0f;
            square_texture_coordinates[6] = 2.0f;
            square_texture_coordinates[7] = 0.0f;

            GLES32.glUniform1i(singleTapUniform, 1);
        } else if (singleTap == 4) {
            // one center smiley pixel on full quad
            square_texture_coordinates[0] = 0.5f;
            square_texture_coordinates[1] = 0.5f;
            square_texture_coordinates[2] = 0.5f;
            square_texture_coordinates[3] = 0.5f;
            square_texture_coordinates[4] = 0.5f;
            square_texture_coordinates[5] = 0.5f;
            square_texture_coordinates[6] = 0.5f;
            square_texture_coordinates[7] = 0.5f;
        ...
        // now use
        GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, square_texture_coordinates.length * 4, floatBufferSquareTextureCoordinates, GLES32.GL_DYNAMIC_DRAW);
        GLES32.glVertexAttribPointer(VertexAttributesEnum.AMC_ATTRIBUTE_TEXTURE_COORDINATES, 2, GLES32.GL_FLOAT, false, 0, 0);
        GLES32.glEnableVertexAttribArray(VertexAttributesEnum.AMC_ATTRIBUTE_TEXTURE_COORDINATES);
        GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, 0);
