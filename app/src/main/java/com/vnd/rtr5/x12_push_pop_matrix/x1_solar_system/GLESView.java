package com.vnd.rtr5.x12_push_pop_matrix.x1_solar_system;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, GestureDetector.OnDoubleTapListener, GestureDetector.OnGestureListener {
    ...
    private void display() {
...

        {
            ...
            Matrix.scaleM(modelViewMatrix, 0, 1.5f, 1.5f, 1.5f);
            ...
            // bind vao
            GLES32.glBindVertexArray(vao_sphere[0]);
            GLES32.glVertexAttrib3f(VertexAttributesEnum.AMC_ATTRIBUTE_COLOR, 1.0f, 0.5f, 0.0f);
            ...
            // transformations
            Matrix.rotateM(modelViewMatrix, 0, year, 0.0f, 1.0f, 0.0f);
            Matrix.translateM(modelViewMatrix, 0, 2.5f, 0.0f, 0.0f);
            Matrix.rotateM(modelViewMatrix, 0, day, 0.0f, 1.0f, 0.0f);
            ...
            // draw the earth
            // instead of changing polygon mode drawn with LINES instead of triangles in glDrawElements
            //GL11.glPolygonMode(GL11.GL_FRONT_AND_BACK, GL11.GL_LINES);

            // bind vao
            GLES32.glBindVertexArray(vao_sphere[0]);
            GLES32.glVertexAttrib3f(VertexAttributesEnum.AMC_ATTRIBUTE_COLOR, 0.4f, 0.9f, 1.0f);
            ...
            // bind vao
            GLES32.glBindVertexArray(vao_sphere[0]);
            GLES32.glVertexAttrib3f(VertexAttributesEnum.AMC_ATTRIBUTE_COLOR, 1.0f, 1.0f, 1.0f);
