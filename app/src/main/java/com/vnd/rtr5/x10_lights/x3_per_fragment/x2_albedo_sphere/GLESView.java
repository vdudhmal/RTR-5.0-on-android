package com.vnd.rtr5.x10_lights.x3_per_fragment.x2_albedo_sphere;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, GestureDetector.OnDoubleTapListener, GestureDetector.OnGestureListener {
    ...
    private final float[] materialDiffused = {0.5f, 0.2f, 0.7f, 1.0f};
    private final float[] materialSpecular = {0.7f, 0.7f, 0.7f, 1.0f};
    ...
    public boolean onSingleTapConfirmed(@NonNull MotionEvent event) {
        singleTap = (singleTap + 1) % 2;
        bLightingEnabled = singleTap == 1;
        return true;
    }
