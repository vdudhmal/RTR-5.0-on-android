package com.vnd.rtr5.x2_orthographic;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, GestureDetector.OnDoubleTapListener, GestureDetector.OnGestureListener {
    ...
    private final float[] orthographicProjectionMatrix = new float[16];
    ...
    private void display() {
        ...
        Matrix.multiplyMM(modelViewProjectionMatrix, 0, orthographicProjectionMatrix, 0, modelViewMatrix, 0); // order of multiplication is very important
